<template>
	...
	<div>
	   <el-card v-loading="loading" class="box-card"  style="padding: 0;margin:20px;padding-left:60px;">
		 ...
		 <div v-show="p_val_10"  class="tab_box"><p>授课门类：</p>
			  <el-tag v-for='i in p_val_10' style='margin-right:10px;'>{{i}}</el-tag>
		 </div>
		 <div v-show="p_val_11"  class="tab_box"><p>证件类型：</p><a>{{p_val_11}}</a></div>
		 <div v-show="p_val_12"  class="tab_box"><p>证件号码：</p><a>{{p_val_12}}</a></div>
		
	<!-- 机构展示 --> 
		 <div v-if="p_val_2=='机构'" style="width:100%;height:250px;margin-top: 20px;">
			 <div class="img_box">
				  <p>教师资格证：</p>
	...
	<!-- 学校展示 --> 	 
		 <div v-else style="width:100%;height:250px;margin-top: 20px;">
		 			 <div class="img_box">
						 <p>证件照（正面）：</p>
	...
	<!-- 其他证件照 -->	 
		 <div class="img_box" style="width:100%;height:230px;">
