<template>
   ...
   <div style="width:100%;float: left;">
	<el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%">
		...
		<el-table-column prop="revised_name" align='center' header-align='center' label="平台课程名称" ></el-table-column>
		<el-table-column prop="name" align='center' header-align='center' label="机构课程名称" ></el-table-column>
