	              ...
	              <div v-show="show_meng" class="transition-box_child">
					  <p style="margin-left:20px;font-weight:600;">{{title_p}}</p>
					   ...
					   <div class="inp_boxs"><p>所在城市：</p>
					        <el-select style='width:450px;' class='tab_c' v-model="cs_val2" placeholder="请选择城市">
					 ...
					 <div class="inp_boxs" style="padding:0;padding-right:23px;"><el-input style='width:450px;float:right;' v-model="input[4]" placeholder="请输入内容">
...
//当区域选项被点击
		qy_click2(i){
			...
			this.qy_id2 = i.region_id;this.jd_val2 = '';this.jd_box2 = [];this.jd_id2 = '';this.jd_fn2();//获取街道数据
